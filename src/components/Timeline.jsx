...
const sorted = [...timelineItems].reverse();
        ...
        {item.isLive && (
          item.type === 'project' ? (
            <span style={{
              ...
              <span style={{ width: 5, height: 5, borderRadius: '50%', background: '#ef4444', display: 'inline-block', boxShadow: '0 0 6px rgba(239,68,68,0.6)', animation: 'pulse 2s infinite' }} />
              LIVE
            </span>
          ) : (
            <span style={{
              display: 'inline-flex', alignItems: 'center', gap: 5,
              fontSize: '0.68rem', fontWeight: 700, padding: '3px 10px', borderRadius: 100,
              background: 'rgba(248,223,22,0.15)', color: '#efd544ff',
              border: '1px solid rgba(248,223,22,0.35)',
            }}>
              <span style={{ width: 5, height: 5, borderRadius: '50%', background: '#efd544ff', display: 'inline-block', boxShadow: '0 0 6px rgba(239,68,68,0.6)', animation: 'pulse 2s infinite' }} />
              PRESENT
            </span>
          )
        )}
